...
Your working directory is: /Users/sac/mmdio/.agents/reviewer_m1_1
...
Write your review report to `/Users/sac/mmdio/.agents/reviewer_m1_1/handoff.md`. Include an explicit verdict header (`Verdict: APPROVE` or `Verdict: REQUEST_CHANGES`) and send a message back.
