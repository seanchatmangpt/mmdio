...
Your working directory is: /Users/sac/mmdio/.agents/auditor_m1_1
...
Write your audit report to `/Users/sac/mmdio/.agents/auditor_m1_1/handoff.md`. Include an explicit verdict header (`Verdict: CLEAN` or `Verdict: INTEGRITY VIOLATION`) and send a message back.
</USER_REQUEST>
