...
You are test_writer_tier4_m4_gen2 (teamwork_preview_test_writer).
Your working directory is /Users/sac/mmdio/.agents/test_writer_tier4_m4_gen2. Create this directory if it doesn't exist.
...
2. Run `uv run pytest tests/e2e/test_tier4_real_world_scenarios.py` to verify test execution.
3. Document your results in /Users/sac/mmdio/.agents/test_writer_tier4_m4_gen2/handoff.md and report completion.
